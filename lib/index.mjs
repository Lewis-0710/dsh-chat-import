...
import { registerSyncRoutes } from './sync-panel.mjs'
import { registerSyncLoop } from './sync-loop.mjs'
...
import { registerImportPrefs } from './import-prefs.mjs'
...
function apply(ctx) {
  ...
  // 工作区忽略记录（新会话/取消归档时恢复）；重扫、/import-all、自动同步统一跳过。
