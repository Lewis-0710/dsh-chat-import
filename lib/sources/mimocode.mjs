...
import { importOpencodeFile, importOpencodeDirectory, readOpencodeDb, readOpencodeDbSummaries } from './opencode.mjs'
...
export async function importMimocodeFile(ctx, target, args, options = {}) {
  return importOpencodeFile(ctx, target, args, { ...options, filter: isMimocodeBackgroundSession, convert: convertMimocodeJson, sourceLabel: 'mimocode' })
}
