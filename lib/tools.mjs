...
import { clineDeriveArgs, collectClineFiles } from './cline.mjs'
import { importGooseFile, importGooseDirectory } from './goose.mjs'
import { importZedFile, importZedDirectory } from './zed.mjs'
import { importCodexFile, importCodexDirectory, previewCodexFile, previewCodexDirectory } from './codex.mjs'
import { importCrushFile, importCrushDirectory, crushDeriveArgs } from './crush.mjs'
...
import { importTeleagentFile, importTeleagentDirectory } from './teleagent.mjs'
...
export function registerTools(ctx, registryDir) {
  ...
  const IMPORT_SOURCES = [
    ...
    // 专属差异（teleagent.db、多账户目录、provider 标签）收在 lib/teleagent.mjs /
