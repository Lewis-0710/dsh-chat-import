...
const CHAT_FORMATS = [
  ...
  ['codex', 'Codex / ChatGPT CLI rollout JSONL (~/.codex/sessions, ~/.codex/archived_sessions)'],
  ...
  ['opencode', 'opencode history db opencode.db (~/.local/share/opencode)'],
  ['mimocode', 'mimocode history db mimocode.db (~/.local/share/mimocode)'],
  ['kilocode', 'Kilo Code history db kilo.db (~/.local/share/kilo)'],
  ...
  ['hermes', 'Hermes history db state.db (~/.hermes)'],
...
const EXTRA_PARAMS = {
  ...
  sessionIds: {
    type: 'array',
    items: { type: 'string' },
    description: 'Optional (opencode/mimocode/zcode only): import only these source session ids.',
  },
  fullHistory: {
    type: 'boolean',
