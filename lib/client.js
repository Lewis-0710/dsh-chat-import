...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const SOURCES = [
      ...
      "opencode", "mimocode", "kilocode", "zcode", "grokbuild", "openclaw", "pi", "hermes", "kimi", "qoder", "workbuddy", "qwen", "continue", "cline", "goose", "zed", "dsh",
    ];
    ...
    const FORMAT_SOURCE = {
      ...
      kimi: "kimi", qoder: "qoder", workbuddy: "workbuddy", qwen: "qwen", continue: "continue", cline: "cline", goose: "goose", zed: "zed", dsh: "dsh",
    };
    // 来源展示名（产品名不翻译）
    const SOURCE_LABELS = {
      ...
      qwen: "QwenWork", continue: "Continue", cline: "Cline", goose: "Goose", zed: "Zed", dsh: "DSH",
    };
