...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const SOURCES = [
      ...
      "opencode", "mimocode", "kilocode", "zcode", "grokbuild", "openclaw", "pi", "hermes", "kimi", "qoder", "workbuddy", "qwen", "continue", "dsh",
    ];
    ...
    const FORMAT_SOURCE = {
      ...
      kimi: "kimi", qoder: "qoder", workbuddy: "workbuddy", qwen: "qwen", continue: "continue", dsh: "dsh",
    };
    // 来源展示名（产品名不翻译）
    const SOURCE_LABELS = {
      ...
      qwen: "QwenWork", continue: "Continue", dsh: "DSH",
    };
