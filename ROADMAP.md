...
| --- | --- | --- |
| 来源数 | 23 源 + 本地 JSONL（13 工具） | 单源 ~ 4 源 |
...
**全部 67 项 ✅ + REQ-66 / REQ-68 待做**（v0.5.0，2026-08-16 收口；REQ-64 见 v0.13.0、REQ-65 见 v0.14.0、REQ-67 见 v0.15.0、REQ-69 见 v0.16.0）——REQ-66 / REQ-68 为已识别但未开工的需求。
